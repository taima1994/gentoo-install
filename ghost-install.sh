...
echo "3. Tải Stage3..."
cd /mnt/gentoo
wget -c https://mirror.freedif.org/gentoo/releases/amd64/autobuilds/current-stage3-amd64-hardened-selinux-openrc/stage3-amd64-hardened-selinux-openrc-20251130T164554Z.tar.xzz
