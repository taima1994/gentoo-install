#!/bin/bash
# ==============================================================================
# GHOST 2025 - GENTOO INSTALLER COMPLETE
# Author: Ghost
# Repository: https://github.com/[your-username]/gentoo-ghost-installer
# ==============================================================================
...
# MIRROR - SỬ DỤNG GENTOO GIT TRỰC TIẾP
readonly GIT_GENTOO="https://gitweb.gentoo.org/repo/gentoo.git"
...
echo "        Sử dụng Gentoo Git trực tiếp"
echo "=================================================="

if [[ $EUID -ne 0 ]]; then
    echo "❌ Cần chạy với quyền root: sudo bash $0"
    exit 1
fi

echo "⚠️  CẢNH BÁO: Toàn bộ dữ liệu trên /dev/sda và /dev/sdb sẽ bị xóa!"
